...
public class CommJob {
  ...
  /**
   * @param targetUserCat the targetUserCat to set
   */
  ...
  /**
   * @param lstTargetUserCatIds the lstTargetUserCatIds to set
   */
  ...
  /**
   * @param isTargetUserAllCat the isTargetUserAllCat to set
   */
  ...
  /**
   * @param targetUserSubCat the targetUserSubCat to set
   */
  ...
  /**
   * @param lstTargetUserSubCatIds the lstTargetUserSubCatIds to set
   */
  ...
  /**
   * @param isTargetUserAllSubCat the isTargetUserAllSubCat to set
   */
