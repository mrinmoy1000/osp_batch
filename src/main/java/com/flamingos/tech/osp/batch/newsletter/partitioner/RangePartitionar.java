...
public class RangePartitionar implements Partitioner {
  ...
  public Map<String, ExecutionContext> partition(int gridSize) {
    ...
    Map<String, Long> recordMap =
        oNamedParameterJdbcTemplate.queryForObject(rangeSql, new HashMap<String, Object>(),
            new RowMapper<Map<String, Long>>() {

              public Map<String, Long> mapRow(ResultSet rs, int arg1) throws SQLException {
