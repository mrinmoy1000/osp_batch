...
public class UserStepListener implements StepExecutionListener {
   ...
   * 
   * @see
   * org.springframework.batch.core.StepExecutionListener#beforeStep(org.springframework.batch.core
   * .StepExecution)
   */
   ...
   * 
   * @see
   * org.springframework.batch.core.StepExecutionListener#afterStep(org.springframework.batch.core
   * .StepExecution)
   */
